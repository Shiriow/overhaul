let forward = {
  ...
  Nightseeker: {
    ...
    returnCloak: { },
    proficiency: { foulMastery: 2 },
    foulMastery: { spreadThrow: 3, shadowBite: 3 },
  ...
  Vampire: {
    ...
    crimsonShower: { bloodPact: 3 },
    bloodPact: { underTheZenith: 3 },
    underTheZenith: { unscathedBody: 3, bloodyCatastrophe: 3 },
    unscathedBody: {  },
    drainBite: { iceVein: 3 },
