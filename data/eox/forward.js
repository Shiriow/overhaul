...
*/
  ...
  Zodiac: {
    ...
    ethericShoot: { antiEther: 2 },
    fireProphecy: { horoscope: 1, meteor: 1 },
    iceProphecy: { horoscope: 1, meteor: 1 },
    voltProphecy: { horoscope: 1, meteor: 1 },
    freeEnergy: { },
    spreadEther: { },
    meteor: { }
  },
  ...
  Vampire: {
    ...
    bareFangs: { bloodbath: 3 },
    bloodbath: { bloodPact: 3 },
    bloodPact: { crimsonOath: 3 },
    bloodTransfer: { phlebotomy: 3 },
    phlebotomy: { rebirthRitual: 3 },
    rebirthRitual: { bloodGather: 3 },
    bloodGather: { riseFromTheDead: 3 },
    vampiricSpirit: { sanguineTide: 3 },
    sanguineTide: { scarletBoon: 3 },
    scarletBoon: { feast: 3 },
    feast: { vampiricGrace: 3 },
    vitalityDrain: { vigorDrain: 3 },
    vigorDrain: { vampiricGrace: 3 },
    bloodyCatastrophe: { },
    crimsonOath: { bloodyCatastrophe: 3, riseFromTheDead: 3 },
    riseFromTheDead: { regeneration: 3, briefImmortality: 3 },
    regeneration: { },
    briefImmortality: { },
    vampiricGrace: { },
    take: { }
