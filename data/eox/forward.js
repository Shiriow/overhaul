let forward = {
  ...
  "War Magus": {
    ...
    ailingSlash: { harvestFestival:2, scorpion: 2 },
    harvestFestival: { },
    scorpion: { },
    leeches: { rouse: 2, bindCut: 2 },
    rouse: { dissection: 2 },
    bindCut: { dissection: 2 },
    dissection: { spiritDrain: 3 },
  ...
  Nightseeker: {
    ...
    assassinate: { },
    proficiency: { spreadThrow: 2 },
    spreadThrow: { foulMastery: 2, shadowBite: 3 },
    foulMastery: { autoSpread: 2 },
