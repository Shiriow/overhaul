let forward = {
  ...
  Survivalistv2: {
    ...
    mistStep: { fanDance: 2 },
    fanDance: { sylphid: 2, sneakAttack: 2 },
    sylphid: { eyeForAnEye: 3 },
    sneakAttack: { eyeForAnEye: 3 },
  ...
  Roninv2: {
    ...
    armStrike: { frigidSlash: 1, mirrorMoon: 1 },
    armorPierce: { frigidSlash: 1, mirrorMoon: 1  },
    drainSlice: { frigidSlash: 1, mirrorMoon: 1 },
    mirrorMoon: { hazeSlash: 1 },
    frigidSlash: { lightningStab: 1 },
